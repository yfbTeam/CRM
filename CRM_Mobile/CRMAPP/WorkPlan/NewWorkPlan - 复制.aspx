    ...
    <div class="mui-content" style="padding-bottom: 1.1rem;">
        <section class="section_module mt20">
            <form class="mui-input-group">
                ...
                <input type="hidden" name="wp_cust_id" id="wp_cust_id" fl="客户名称" isrequired="true" value="">
                <input type="hidden" name="wp_link_id" id="wp_link_id" fl="联系人" isrequired="true" value="">
                ...
                <div class="input-row clearfix">
                    ...
                    <div class="input fr">
                        <input type="text" name="cust_customer" readonly="readonly" fl="客户名称" id="cust_customer" class="text" placeholder="请选择客户名称[必填]" />
                        <i class="iconfont">&#xe64c;</i>
                    </div>
                </div>
                <div class="input-row clearfix">
                    ...
                    <div class="input fr">
                        <input type="text" name="link_name" readonly="readonly" fl="联系人" id="link_name" class="text" placeholder="请选择联系人[必填]" />
                        <i class="iconfont">&#xe64c;</i>
                    </div>
                </div>
...
<script type="text/javascript">
    document.write("<s" + "cript type='text/javascript' src='/js/pagejs/new_workplan.js?fddf=ooo&number=" + Math.random() + "'></s" + "cript>");
</script>
...
<script>
    ...
    if (localStorage.getItem("wp_cust_name") != null && localStorage.getItem("wp_cust_name") != undefined) {
        if ($("#cust_customer").val() != localStorage.getItem("wp_cust_name")) {//如果选择的
            $("#link_name").val("");
            $("#link_position").html("");
            $("#wp_link_id").val("");
        }
        $("#cust_customer").val(localStorage.getItem("wp_cust_name"));
