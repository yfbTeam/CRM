...
namespace DDHelper.Common
{
    public class Cryptography
    {
        ...
        /// 秘钥序列号
        /// </summary>
        static string codeSerial = "2,3,4,5,6,7,a,c,d,e,f,h,i,j,k,m,n,p,r,s,t,A,C,D,E,F,G,H,J,K,M,N,P,Q,R,S,U,V,W,X,Y,Z";
        ...
        private static byte[] KCS7Encoder(int text_length)
        {
            ...
            try
            {
                ...
                returnData = Encoding.UTF8.GetBytes(tmp);
            }
            catch (Exception ex)
            {
                LogHelper.Error(ex);
        ...
        private static byte[] decode2(byte[] decrypted)
        {
            ...
            try
            {
                ...
                res = new byte[decrypted.Length - pad];
